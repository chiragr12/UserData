...
@org.adempiere.base.Model(table="c_mom_discussionline")
public class X_c_mom_discussionline extends PO implements I_c_mom_discussionline, I_Persistent 
{
    ...
    /** Standard Constructor */
    public X_c_mom_discussionline (Properties ctx, int c_mom_discussionline_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, c_mom_discussionline_ID, trxName, virtualColumns);
      /** if (c_mom_discussionline_ID == 0)
        {
        } */
    }
    ...
    {
      StringBuilder sb = new StringBuilder ("X_c_mom_discussionline[")
