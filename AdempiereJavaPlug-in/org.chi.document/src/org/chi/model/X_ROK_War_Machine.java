...
@org.adempiere.base.Model(table="ROK_War_Machine")
public class X_ROK_War_Machine extends PO implements I_ROK_War_Machine, I_Persistent 
{
    ...
    /** Standard Constructor */
    public X_ROK_War_Machine (Properties ctx, int ROK_War_Machine_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, ROK_War_Machine_ID, trxName, virtualColumns);
      /** if (ROK_War_Machine_ID == 0)
        {
        } */
    }
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ROK_War_Machine[")
